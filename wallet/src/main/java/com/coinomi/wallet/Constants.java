...
public class Constants {
    ...
    public static final String BINARY_URL = "https://github.com/BitCoin ONE/BitCoin ONE/releases";

    public static final String VERSION_URL = "https://www.bitcoinone.ioversion";
    public static final String PARTNERS_URI = "https://www.bitcoinone.iopartner.json";
    public static final String SUPPORT_EMAIL = "bitcoinone@gmail.com";
